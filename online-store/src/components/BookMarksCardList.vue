...
<template>
  <ul
    class="grid mt-4 lg:grid-cols-4 gap-11 md:justify-between min-[320px]:justify-items-center min-[600px]:grid-cols-3 min-[510px]:grid-cols-2 min-[425px]:grid-cols-1"
  >
